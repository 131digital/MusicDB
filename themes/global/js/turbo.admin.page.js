...
$(document).ready(function() {
	if($("#side-content-right").length) {
		if($("#content").height() < $("#side-content-right").height() ) {
			$("#content").height($("#side-content-right").height() + 100);
		}
	}
	if($("#side-content-left").length) {
		if($("#content").height() < $("#side-content-left").height() ) {
			$("#content").height($("#side-content-left").height() + 100);
		}
	}	
