	...
	<div id="s-tab-editcat">
        ...
        <form action="javascript: void(0)" onsubmit="javascript: go_post('admin/categories/edit',this,'admin/categories');" method="post" 
    ...
    <form action="javascript: void(0)" onsubmit="javascript: go_post('admin/categories/addnew',this,'admin/categories');" method="post" enctype="multipart/form-data" id="cat_frm_add" name="cat_frm_add">
